...
public final class SearchviewItemBinding implements ViewBinding {
  ...
  private SearchviewItemBinding(@NonNull TextView rootView, @NonNull TextView text1) {
  ...
  public static SearchviewItemBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.searchview_item, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  public static SearchviewItemBinding bind(@NonNull View rootView) {
    ...
    return new SearchviewItemBinding((TextView) rootView, text1);
  }
}
